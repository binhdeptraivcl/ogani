                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
								...
								?>
                                <ul>
                                    <li><?=$value['product_name']?> <span><?= number_format($value['price']*$_SESSION['amount'][$k], 0, '', ',') . " VND" ?></span></li>
                                    
                                    <!-- <li>Fresh Vegetable <span>$151.99</span></li>
                                    <li>Organic Bananas <span>$53.99</span></li> -->
                                </ul>
							  <?php endforeach; ?>
                                <div class="checkout__order__subtotal">Subtotal <span><?= number_format(($sum ), 0, '', ',') . " VND" ?></span></div>
                                <div class="checkout__order__total">Total <span><?= number_format(($sum ), 0, '', ',') . " VND" ?></span></div>
                                <div class="checkout__input__checkbox">
                                    <label for="acc-or">
                                        Create an account?
