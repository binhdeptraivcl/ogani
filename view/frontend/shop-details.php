...
<body>
    ...
    <section class="product-details spad">
        <div class="container">
            <form action="<?=AddCART.$detail['id']?>" method="post">
                <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large"
                                src="<?=folder?><?=$detail['image']?>" alt="">
                        </div>
                        <div class="product__details__pic__slider owl-carousel">
                        <?php foreach($data['products'] as $value) :?> 

                            <a href = "<?=URL?>shop_details/<?=$value['id']?>"><img data-imgbigurl="<?=folder?><?=$value['image']?>"
                                src="<?=folder?><?=$value['image']?>" alt=""></a>
                    <?php endforeach; ?>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price"><?= number_format(($detail['price'] ), 0, '', ',') . " VND" ?></div>
                        ...
                        <!-- <a href="<?=URL?>addTocart/<?=$detail['id']?>" class="primary-btn">ADD TO CARD</a> -->
