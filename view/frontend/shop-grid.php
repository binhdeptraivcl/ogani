            ...
            <div class="row">
                                    ...
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="<?=import?>img/latest-product/lp-1.jpg" alt="">
                                            </div>
                                        ...
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="<?=import?>img/latest-product/lp-2.jpg" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6>Crab Pool Security</h6>
                                                <span>$30.00</span>
                                        ...
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="<?=import?>img/latest-product/lp-3.jpg" alt="">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6>Crab Pool Security</h6>
                                                <span>$30.00</span>
                ...
                <div class="col-lg-9 col-md-7">
                    <div class="product__discount">
                        ...
                        <?php foreach($data['best'] as $value) : ?>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="<?=folder?><?=$value['image']?>">
                                            <div class="product__discount__percent">-20%</div>
                                            <ul class="product__item__pic__hover">
                                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                                <li><a href="<?=AddCART.$value['id']?>"><i class="fa fa-shopping-cart"></i></a></li>
                                            </ul>
                                        </div>
                                        <div class="product__discount__item__text">
                                            <span><?=$value['product_name']?></span>
                                            <h5><a href="<?=URL?>shop_details/<?=$value['id']?>"><?=$value['product_name']?></a></h5>
                                            <div class="product__item__price"><?= number_format(($value['price']) -($value['price'])*0.2 , 0, '', ',') . " VND" ?> <span><?=number_format(($value['price'] ), 0, '', ',') . " VND" ?></span></div>
                                        </div>
                                    </div>
                                </div>
                        <?php endforeach; ?>
                ...
                foreach($data['category'] as $value) :?> 
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="<?=folder?><?=$value['image']?>">
                                        <ul class="product__item__pic__hover">
                                            <li><a href="#"><i class="fa fa-heart"></i></a></li>
