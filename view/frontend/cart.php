                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img style="width: 100px;height:100px;" src="<?=folder?><?=$value['image']?>" alt="">
                                    ...
                                    <td class="shoping__cart__quantity">
                                        <div class="quantity">
                                            <div class="pro-qty">
                                                <input type="text" name="quantity" value="<?php $k=array_search($value['id'],$_SESSION['cart']);
									 echo $_SESSION['amount'][$k]?>" min="1" max="100">
                                            </div>
                                        </div>
                                    </td>
                                    <td class="shoping__cart__total">
                                    <?= number_format($value['price']*$_SESSION['amount'][$k], 0, '', ',') . " VND" ?>
                                    </td>
                                    <td class="shoping__cart__item__close">
                                        <a href="<?=RmCART.$value['id']?>"> 
                                        <span class="icon_close"></span>
                                        </a>
                                        <?php
                                        $sum +=$value['price']*$_SESSION['amount'][$k];
                                        ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        <a href="<?=URL?>shop_grid/1" class="primary-btn cart-btn">CONTINUE SHOPPING</a>
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        ...
                        ?>
                            <li>Subtotal <span><?= number_format(($sum ), 0, '', ',') . " VND" ?></span></li>
                            <li>Total <span><?= number_format(($sum ), 0, '', ',') . " VND" ?></span></li>
                        </ul>
